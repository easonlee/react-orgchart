...
var ChartNode = function ChartNode(_ref) {
  ...
  var addArrows = function addArrows(e) {
    ...
    var isSiblingsCollapsed = false;
    if (node && node.parentNode && node.parentNode.children) {
      isSiblingsCollapsed = Array.from(node.parentNode.children).some(function (item) {
  ...
  return _react.default.createElement("li", {
    ...
    className: "oc-edge verticalEdge bottomEdge oci ".concat( bottomEdgeExpanded ? "fas fa-minus" : "fas fa-plus"),
